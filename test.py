...
def main_single(args):
    ...
    img_auc, pix_auc, pro_auc, mask_auc = test(args)

    return img_auc, pix_auc, pro_auc, mask_auc
...
def main():
    ...
    img_aucs, pixel_aucs, pro_aucs, mask_aucs = [], [], [], []
    ...
    for class_name in CLASS_NAMES:
        ...
        img_auc, pix_auc, pro_auc, mask_auc = main_single(args)
        img_aucs.append(img_auc)
        pixel_aucs.append(pix_auc)
        pro_aucs.append(pro_auc)
        mask_aucs.append(mask_auc)
    for i, class_name in enumerate(CLASS_NAMES):
        print(f'{class_name}: Image-AUC: {img_aucs[i]}, Pixel-AUC: {pixel_aucs[i]}, Pro-AUC: {pro_aucs[i]}, Mask-AUC: {mask_aucs[i]}')
    ...
    print('Mean Mask-AUC: {}'.format(np.mean(mask_aucs)))
